...
export const Calculator = () => {
  ...
  const btnClick = (item) => {
    ...
    if (item.action === CALC_BTNS.THEME) document.body.classList.toggle('dark');

    if (item.action === CALC_BTNS.ADD) {
    ...
    if (item.action === CALC_BTNS.DELETE) {
